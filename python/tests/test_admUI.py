...
examples = [
    dit.Distribution(['000', '011', '101', '110'], [1. / 4] * 4), # XOR
    dit.Distribution(['000', '011', '101', '110'], [0.1, 0.2, 0.3, 0.4]), # perturbed XOR
    dit.Distribution(['000', '001', '010', '111'], [1. / 4] * 4), # AND
    dit.Distribution(['012', '020', '101', '102', '120'], [0.421568114489, 0.0786651096858, 0.253963103031, 0.160027829754, 0.08577584304]),
    dit.Distribution(['012', '020', '101', '102', '120'], [0.4, 0.1, 0.25, 0.16, 0.09]),
    dit.Distribution(['000', '001', '010', '011', '100', '101', '110', '111'],
    ...
    dit.Distribution(['000', '001', '010', '011', '101', '110', '200', '201', '210'],
